...
relative inline-block max-w-full cursor-pointer border-b-[2px] bg-transparent px-0 py-[8px] text-left align-top text-[#222222] opacity-100 transition-all duration-[300ms] ease-[ease] [text-decoration:none] max-mobile-landscape:block
${(p) =>
  p.$isSelected
